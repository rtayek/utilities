...
public class Utilities {
	...
	static List toStrings(final BufferedReader r) {
	...
	static List getFileAsListOfStrings(final File file) {
		BufferedReader r = null;
		try {
			r = new BufferedReader(new FileReader(file));
			final List l = toStrings(r);
			r.close();
			return l;
		} catch (IOException e) {
			throw new RuntimeException(e);
	...
	static List getDataThatMayHaveLineFeeds(final String[] data) {
