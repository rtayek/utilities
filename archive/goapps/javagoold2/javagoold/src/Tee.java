...
public class Tee extends FilterOutputStream /* make this into a writer or make a version for writers */ { // tee utility
	...
	public synchronized void write(int b) throws IOException {
		...
		{ OutputStream out=(OutputStream) e.nextElement(); out.write(b); out.flush(); }
	}
	public synchronized void write(byte[] data,int offset,int length) throws IOException {
		for(Enumeration e=stream.elements(); e.hasMoreElements();)
		{ OutputStream out=(OutputStream) e.nextElement(); out.write(data, offset, length); out.flush(); }
	}
	public static void tee(File file) { tee(file,true); }
