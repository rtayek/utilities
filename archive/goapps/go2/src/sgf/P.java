...
abstract class P1 extends P {
	P1(String id,String ff,String description,String type,String value) {
		super(id,ff,description,type,value);
	}
...
class Move extends P1 {
	Move(String id,String ff,String description,String type,String value) {
		super(id,ff,description,type,value);
	}
	//int x,y;
}
class Setup extends P1 {
	Setup(String id,String ff,String description,String type,String value) {
		super(id,ff,description,type,value);
	}
}
class Root extends P1 {
	Root(String id,String ff,String description,String type,String value) {
		super(id,ff,description,type,value);
	}
}
class GameInfo extends P1 {
	GameInfo(String id,String ff,String description,String type,String value) {
		super(id,ff,description,type,value);
	}
}
class NoType extends P1 {
	NoType(String id,String ff,String description,String type,String value) {
		super(id,ff,description,type,value);
	}
}
public abstract class P {
	...
	public static final P[] p={AB,AE,AN,AP,AR,AS,AW,B,BL,BM,BR,BS,BT,C,CA,CH,CP,CR,DD,DM,DO,DT,EL,EV,EX,FF,FG,GB,GC,GM,GN,GW,HA,HO,ID,IP,IT,IY,KM,KO,L,LB,LN,LT,M,MA,MN,N,OB,OM,ON,OP,OT,OV,OW,PB,PC,PL,PM,PW,RE,RG,RO,RR,RU,SC,SE,SE2,SI,SL,SO,SQ,ST,SU,SZ,TB,TC,TE,TM,TR,TW,UC,US,V,VW,W,WL,WR,WS,WT,};
}
