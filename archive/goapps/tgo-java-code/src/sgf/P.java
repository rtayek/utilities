...
public abstract class P {
    ...
    private static final P[] ps= {AB,AE,AN,AP,AR,AS,AW,B,BL,BM,BR,BS,BT,C,CA,CH,CP,CR,DD,DM,DO,DT,EL,EV,EX,FF,FG,GB,GC,
            GM,GN,GW,HA,HO,ID,IP,IT,IY,KM,KO,L,LB,LN,LT,LZ,M,MA,MN,N,OB,OM,ON,OP,OT,OV,OW,PB,PC,PL,PM,PW,RE,RG,RO,RR,RU,
            SC,SE,SE2,SI,SL,SO,SQ,ST,SU,SZ,TB,TC,TE,TM,TR,TW,UC,US,V,VW,W,WL,WR,WS,WT,};
